(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".best-sellers__slider")) new swiper_core_Swiper(".best-sellers__slider", {
            ...
            speed: 800,
            scrollbar: {
                el: ".controls-best-sellers__scrollbar",
                draggable: true
            },
            navigation: {
                prevEl: ".controls-best-sellers__arrow-prev",
                nextEl: ".controls-best-sellers__arrow-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.8,
        ...
        if (document.querySelector(".interior__slider")) new swiper_core_Swiper(".interior__slider", {
            ...
            speed: 800,
            scrollbar: {
                el: ".controls-interior__scrollbar",
                draggable: true
            },
            navigation: {
                prevEl: ".controls-interior__arrow-prev",
                nextEl: ".controls-interior__arrow-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.8,
        ...
        if (document.querySelector(".marble__slider")) new swiper_core_Swiper(".marble__slider", {
            modules: [ Navigation, Scrollbar ],
            observer: true,
            observeParents: true,
            slidesPerView: 2.23,
            ...
            speed: 800,
            scrollbar: {
                el: ".controls-marble__scrollbar",
                draggable: true
            },
            navigation: {
                prevEl: ".controls-marble__arrow-prev",
                nextEl: ".controls-marble__arrow-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.8,
        ...
        if (document.querySelector(".thumbs-images-product")) {
            const thumbsSwiper = new swiper_core_Swiper(".thumbs-images-product", {
        ...
        if (document.querySelector(".similar-product__slider")) new swiper_core_Swiper(".similar-product__slider", {
            modules: [ Navigation, Scrollbar ],
            observer: true,
            observeParents: true,
            slidesPerView: 3.9,
            ...
            speed: 800,
            scrollbar: {
                el: ".controls-similar-product__scrollbar",
                draggable: true
            },
            navigation: {
                prevEl: ".controls-similar-product__arrow-prev",
                nextEl: ".controls-similar-product__arrow-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.8,
    ...
    da.init();
    let pictureSlide = document.querySelectorAll(".images-product__picture");
    pictureSlide.forEach((image => {
        let srcPicture = image.getAttribute("src");
        if (image && srcPicture.length == 0) image.closest(".swiper-slide").classList.add("_display");
    }));
    window["FLS"] = true;
    isWebp();
    addTouchClass();
